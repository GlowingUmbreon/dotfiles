...
jq -r '.[0].videos | reverse | to_entries | .[] | .value+{key:.key} | [.key+1,0,"https://www.youtube.com/watch?v="+.videoId,.title,"VIDEO_STREAM",.lengthSeconds,.author,"https://www.youtube.com/channel/"+.authorId,"https://i.ytimg.com/vi/"+.videoId+"/mqdefault.jpg",.viewCount,"",.timeAdded,1] | @csv' ~/.dotfiles/freetube/playlists.db >> streams.csv
